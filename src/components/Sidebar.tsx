...
export default function Sidebar() {
  ...
  return (
    <div
      className={`fixed top-1/2 -translate-y-1/2 left-2 z-50 h-[56vh] w-14 rounded-3xl flex flex-col items-center justify-between py-4 px-1 shadow-xl transition-colors duration-300
